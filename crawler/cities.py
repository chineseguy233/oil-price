...
"""
PROVINCES = {
    '北京': ['北京市', '东城区', '西城区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区', '密云区', '延庆区'],
    ...
    '重庆': ['重庆市', '万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区'],
    ...
    '黑龙江': ['哈尔滨市', '齐齐哈尔市', '鸡西市', '鹤岗市', '双鸭山市', '大庆市', '伊春市', '佳木斯市', '七台河市', '牡丹江市', '黑河市', '绥化市', '大兴安岭'],
...
# 油价数据URL映射 (省市通用一个源，但可以分别请求)
CITY_URLS = {}
for province, cities in PROVINCES.items():
    for city in cities:
        # 市级使用对应的拼音URL
        city_pinyin = city.replace('市', '').replace('区', '').replace('县', '')
        CITY_URLS[city] = f"http://www.qiyoujiage.com/{city_pinyin}.shtml"
